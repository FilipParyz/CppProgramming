...
void remove_first_node_with_value(struct Node** head, int value) {
    if (*head == NULL) {
        return;
    }
...
int main() {
    ...
    remove_first_node_with_value(&head, 8);
    printf("Linked list after removing first node with value 8: ");
    print_linked_list(head);

    insert_at_index(&head, 8, 3);
    printf("Linked list after inserting 8 at index 3: ");
    print_linked_list(head);
